...
abaqus interactive job=$JOBNAME input=$INPUTFILE cpus=$SLURM_NTASKS threads_per_mpi_process=$THREADS_PER_MPI global=$GLOBMOD memory="$ABAQUS_MEM_ARG" user=$SUBROUTINE_PATH
