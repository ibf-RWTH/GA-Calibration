...
### Job name
#SBATCH --job-name=CP_Calibration_7034
### Account
#SBATCH --account=rwth1393
### File/Path where STDOUT will be written to, %J is the job id
#SBATCH --output /home/rwth1393/GA-Calibration/logs/CP_Calibration_7034-log.%J
